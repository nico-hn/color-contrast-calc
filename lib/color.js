...
class SearchCriteria {
  ...
  static thresholdCriteria(targetRatio, fixedColor, otherColor) {
    if (fixedColor.shouldScanDarkerSide(otherColor)) {
...
class Color {
  ...
  findBrightnessThreshold(otherColor, level = "AA") {
    ...
    const criteria = SearchCriteria.thresholdCriteria(targetRatio, this, otherColor);
  ...
  shouldScanDarkerSide(otherColor) {
    return SearchCriteria.shouldScanDarkerSide(this, otherColor);
  }
