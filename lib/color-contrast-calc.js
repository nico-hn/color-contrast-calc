  ...
  class Sorter {
    ...
    static compareHexFunction(colorOrder = "rgb") {
      ...
      return function(hex1, hex2) {
        return Sorter.compareHexVal(hex1, hex2, order, componentsCache);
      };
    }
    ...
    static compareHexVal(hex1, hex2, order, componentsCache) {
      const color1 = this.hexToComponents(hex1, order, componentsCache);
      const color2 = this.hexToComponents(hex2, order, componentsCache);

      return this.compareColorComponents(color1, color2, order.pos, order.funcs);
    }
