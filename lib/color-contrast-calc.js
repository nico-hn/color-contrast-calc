...
class ColorContrastCalc {
  ...
  newSaturateColor(s, name = null) {
    return this.generateNewColor(this.constructor.SaturateCalc, s, name);
  }

  newGrayscaleColor(s, name = null) {
    return this.generateNewColor(this.constructor.GrayscaleCalc, s, name);
  }
