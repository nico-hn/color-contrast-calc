...
class ColorContrastCalc {
  ...
  static hexCodeToDecimal(hexCode) {
    return ColorUtils.hexCodeToDecimal(hexCode);
  }
  ...
  static normalizeHexCode(hexString) {
    return ColorUtils.normalizeHexCode(hexString);
  }
  ...
  static decimalToHexCode(rgb) {
    return ColorUtils.decimalToHexCode(rgb);
  }
  ...
  static isValidRgb(rgb) {
    return ColorUtils.isValidRgb(rgb);
  }
  ...
  static isValidHexCode(code) {
    return ColorUtils.isValidHexCode(code);
  }
   ...
   */
  static isString(str) {
    return ColorUtils.isString(str);
  }
  ...
  static isUpperCase(str) {
    return ColorUtils.isUpperCase(str);
  }
