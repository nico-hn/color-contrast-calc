...
class ColorContrastCalc {
  ...
  static compareRgbFunction(colorOrder = "rgb") {
    return this.Sorter.compareRgbFunction(colorOrder);
  }
  ...
  static compare(color1, color2, colorOrder = "rgb") {
    return (this.compareRgbFunction(colorOrder))(color1, color2);
  }
...
(function() {
  ...
  class Sorter {
    static sort(colors, colorOrder = "rgb", keyMapper = null, mode = "auto") {
      let compare = this.compareRgbFunction(colorOrder);

      if (mode === "hex" ||
          mode === "auto" && this.isStringKey(colors[0], keyMapper)) {
    ...
    static isStringKey(color, keyMapper) {
      ...
      return ColorContrastCalc.isString(keyType);
    }
