...
class ColorContrastCalc {
   ...
   * @param {ColorContrastRatio} foreground
   * @param {ColorContrastRatio} background
  ...
  /**
   * Returns an instance of ColorContrastCalc for predefined color names.
  ...
  newSaturateColor(percent, name = null) {
    return this.generateNewColor(this.constructor.SaturateCalc, percent, name);
  }

  newGrayscaleColor(percent, name = null) {
    return this.generateNewColor(this.constructor.GrayscaleCalc, percent, name);
  }
